...
const { auth, after, queryCek, paramCek, schemaCek } = require("../../../helpers");
const router = express.Router()
const c = require('./chickenShed-image.controller')
const {schema} = require('./chickenShed-image.validation')
