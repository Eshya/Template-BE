...
router.get('/list/peternak', auth, permition('superadmin', 'peternak'), paramCek, c.listKandangPeternak)
router.get('/list/ppl', auth, permition('superadmin', 'ppl'), paramCek, c.listKandangPPL)
